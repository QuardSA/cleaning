            ...
            <div class="form_registration" id="form_registration">
                <div class="form-container sign-up-container">
                    <form action="/signup_validation" class="auth_reg" method="POST">
                        ...
                        <div class="form-floating w-100">
                            <input type="password" class="form-control border-info" id="password" value=""
                        ...
                        <div class="form-floating w-100">
                            <input type="password" class="form-control border-info" id="confirm_password" value=""
                                placeholder="{{ old('confirm_password') }}" name="confirm_password">
